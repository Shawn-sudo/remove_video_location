package com.example.remove_video_metadata
...
class RemoveVideoMetadataPlugin : FlutterPlugin, MethodChannel.MethodCallHandler {
  ...
  companion object {
    private const val CHANNEL = "remove_video_metadata"
